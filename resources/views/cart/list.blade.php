...
<div id="main" >
   ...
   <div class="wrapper wrapper-breadcrumb hidden-xs hidden-sm">
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               <span itemscope itemtype="https://data-vocabulary.org/Breadcrumb"><a href="/" itemprop="url"><span itemprop="title">Trang chủ</span></a></span> » Giỏ hàng
            </div>
         </div>
      </div>
   </div>
   <div class="wrapper wrapper-main-content" style="padding-bottom: 150px">
      <div class="container">
      
         <div class="row cart-ajax-new">
            @if(count($cart)>0)
